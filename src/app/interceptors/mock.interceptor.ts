...
const NO_AUTH_ENDPOINTS = ['sessions', 'config', 'service_announcements_public'];

export class MockInterceptorOptions {
  public static AUTHENTICATION_ENABLED: boolean = true;
}
...
export const mockInterceptor: HttpInterceptorFn = (
  ...
  function handleRoute() {
    if (MockInterceptorOptions.AUTHENTICATION_ENABLED && !isLoggedIn() && !(NO_AUTH_ENDPOINTS.includes(endpoint))) {
      return unauthorized();
    }
    switch (true) {
