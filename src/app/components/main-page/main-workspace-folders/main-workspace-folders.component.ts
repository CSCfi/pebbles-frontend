...
@Component({
  selector: 'app-main-workspace-folders',
  templateUrl: './main-workspace-folders.component.html',
  styleUrls: ['./main-workspace-folders.component.scss']
})
export class MainWorkspaceFoldersComponent implements OnInit {
